ace.define("ace/mode/jsasm_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;

var JsasmHighlightRules = function() {
...
JsasmHighlightRules.metaData = { fileTypes: [ 'jsasm' ],
      name: 'JS Assembler',
      scopeName: 'source.jsasm' };


oop.inherits(JsasmHighlightRules, TextHighlightRules);

exports.JsasmHighlightRules = JsasmHighlightRules;
});
...
ace.define("ace/mode/jsasm",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/jsasm_highlight_rules","ace/mode/folding/coffee","ace/worker/worker_client"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var JsasmHighlightRules = require("./jsasm_highlight_rules").JsasmHighlightRules;
var FoldMode = require("./folding/coffee").FoldMode;
var WorkerClient = require("../worker/worker_client").WorkerClient;

var Mode = function() {
    this.HighlightRules = JsasmHighlightRules;
...
(function() {
    ...
    this.createWorker = function(session) {
        var worker = new WorkerClient(["ace"], "ace/mode/jsasm_worker", "JsasmWorker");
